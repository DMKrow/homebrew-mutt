...
class Mutt < Formula
  ...
  patch do
    # source (copied to the repo) url "http://ftp.fr.openbsd.org/pub/OpenBSD/distfiles/mutt/trashfolder-1.6.0.diff.gz
  ...
  patch do
    # source (copied to the repo) url "http://ftp.fr.openbsd.org/pub/OpenBSD/distfiles/mutt/sidebar-1.6.0.diff.gz
    url "https://raw.githubusercontent.com/emmanuelbernard/homebrew-mutt/master/patchs/sidebar-1.6.0.diff.gz"
